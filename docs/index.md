...
Lors de la requête d’un utilisateur, le template génère une page HTML, l'enrichit du contenu qu’il aura extrait de la base de données et des fichiers XML de contenu, afin de le mettre en forme selon les instructions écrites par le maquettiste.
